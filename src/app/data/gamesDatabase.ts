...
export const gamesDatabase: games[] = [
    {
        gamesId: 1,
        gamesCover: "https://i.imgur.com/H5LfMWf.jpg",
        ...
        gamesElements: [
            {
                elementoTipo: 'img',
                elementoConteudo: 'https://i.imgur.com/H5LfMWf.jpg',
                elementoAcessibilidade: 'Imagem do jogo The Last of Us 2, com a protagonista Ellie em uma mata verde.'
            },
            {
                elementoTipo : 'h2',
                elementoConteudo: 'The Last of Us II.'
            },
            {
                elementoTipo: 'p',
                elementoConteudo: 'Depois do primeiro jogo, os personagens Ellie e joel resolveram morar em jackson em wyoming longe dos infectados, 5 anos depois assumimos o controle da Ellie, uma das protagonistas do jogo, eles viviam uma vida pacata onde encontraram alguma paz, porém isso muda de uma hora para outra, passando por conflitos, traumas e ameaças,com isso Ellie sai em uma nova jornada em busca de vingança.'
            },
            {
                elementoTipo : 'h2',
                elementoConteudo: 'Acessibilidades do jogo.'
            },
            {
                elementoTipo: 'p',
            ...
            {
                elementoTipo: 'h2',
                elementoConteudo: 'Navegação e Travessia.'
            },
            {
                elementoTipo: 'p',
                elementoConteudo: 'A navegação e travessia é uma assistência de navegação usada para guiá-los pelo caminho da história central do jogo, ou você pode usar o modo ‘Enhanced Listen’ para identificar e procurar inimigos e itens em vez disso. Para ajudar a se mover pelo mundo do jogo, também temos opções de transporte simples, proteções em beiradas contra queda e a habilidade de pular os puzzles completamente.'
            },
            {
                elementoTipo: 'img',
            ...
            {
                elementoTipo: 'h2',
                elementoConteudo: 'Controles Alternativos.'
            },
            {
                elementoTipo: 'p',
            ...
            {
                elementoTipo: 'p',
                elementoConteudo: 'O alto contraste ajuda a identificar os personagens, itens e textos na tela, Para que jogadores com visão reduzida possam interpretar elementos visuais, uma configuração fundamental para os jogadores com deficiência visual.'
            },
            {
                elementoTipo: 'img',
            ...
            {
                elementoTipo: 'h2',
                elementoConteudo: 'Assistência Sonora.'
            },
            {
                elementoTipo: 'p',
                elementoConteudo: 'Esta opção irá emitir sons e a localização dos inimigos facilitando o encontro dos adversários nos cenários.'
            }
        ]
